...
<html lang="es">
    ...
    <body>
                            ...
                            <form id="contactForm">
                                <div class="row">
                                    <select class="col" name="id_distrito" onchange="url(this.value);">
                                        <option value="0">--ESCOGE TU DISTRITO--</option>
        ...
        <script>
            <%
            ArrayList<Tienda> lista = (ArrayList<Tienda>)request.getAttribute("tiendas");
            String pedido = (String)session.getAttribute("codpedido");
            String inicioLatitud = (String)request.getAttribute("inicioLatitud");
            String inicioLongitud = (String)request.getAttribute("inicioLongitud");
            %>
            ...
            %>
                                        ...
                                        contentString[<%=i%>] = '<div class="info_content">' +
                                                '<h3>' + nombre[<%=i%>] + '</h3>' +
                                                '<p><a href="ControladorProductoCatalogo?txtTienda=<%=lista.get(i).getId()%>&codped=<%=pedido%>">Tienda</a></p>' + '</div>';
            <% } %>
