            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form id="contactForm" action="ControladorAutentificar" >
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="user" name="txtUsuario" placeholder="Usuario" required data-error="Porfavor ingresa tu usuario">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="password" placeholder="Password" id="password" class="form-control" name="txtPass" required data-error="Porfavor ingresa tu password">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                      <div class="submit-button text-center">
                                         <input  class="btn hvr-hover" type="submit" value="Iniciar Sesion">
                        ...
                        <p align="center"><a href="registrar.jsp">Si no tienes un usuario registrate aqui</a></p>
