              ...
              <div class="row">
                ...
                %>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">Calificaci髇 de la tienda: <%= aux.getCalificacion()%></p><br>
                            <a href="ControladorProductoTienda?txtTienda=<%= aux.getId()%>&termino=nada&criterio=nada" style ="background:#d43b33; border:2px;border-color: white;width: 97%;" class="btn btn-primary">Catalogo de productos</a><br>
                                    ...
                                    <a href="ControladorMostrarPedidosAten?txtTienda=<%= aux.getId()%>" class="btn btn-primary" style ="background:#cccdd7;color:black; border:2px;border-color: white;width: 32%;" >Atenci髇 de pedidos</a>
