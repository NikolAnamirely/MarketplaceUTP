                ...
                <form action="ControladorRegistrarPedidoNuevo" >
                    <div class="row">	       
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <p>Subtotal: </p>
                                <input style="border:0" type="text" class="form-control" name="subtotal" value="<%=lista.getSubtotal()%>" >
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <p>Igv: </p>
                                <input style="border:0" type="text" class="form-control" name="igv" value="<%=lista.getIgv()%>" type="hidden">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <p>Total: </p>
                                <input style="border:0" type="text" class="form-control" name="total" value="<%=lista.getTotal()%>" type="hidden">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <input class="form-control" name="fechacreacion" value="<%=lista.getFecha_creacion()%>" type="hidden">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <p>Fecha Entrega: </p>
                                <input type="date" class="form-control" name="fechaentrega" value="<%=lista.getFecha_entrega()%>" type="hidden">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <p>Hora Entrega: </p>
                                <input type="time" class="form-control" name="horaentrega" value="<%=lista.getHora()%>" type="hidden">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="submit-button text-center">
                                <button class="btn hvr-hover" id="submit" type="submit">Registrar Pedido</button>
