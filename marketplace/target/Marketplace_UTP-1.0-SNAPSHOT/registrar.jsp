                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <div class="contact-form-right">
                            ...
                            <form action="ControladorClienteNuevo" method="POST">
                                <div class="row">
                                           
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input minlength="3" maxlength="20" type="text" class="form-control" id="name" name="nombre" placeholder="Nombre" required="" pattern="[a-z,A-Z]+" required data-error="Porfavor ingresa tu nombre">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input minlength="9" maxlength="12" type="text  " placeholder="Telefono" id="Telefono" class="form-control" name="telefono" required="" pattern="[+,0-9]+" required data-error="Porfavor ingresa tu teléfono">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input minlength="10" maxlength="30" type="text" placeholder="Dirección" id="direccion" class="form-control" name="direccion" required data-error="Porfavor ingresa tu dirección">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>                               
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input minlength="11" maxlength="50" type="email" placeholder="Correo" id="email" class="form-control" name="email" required data-error="Porfavor ingresa tu correo">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="submit-button text-center">
                                            <input  class="btn hvr-hover" type="submit" value="Registrar Cliente">
                                        </div>
                                    </div>                     
                                </div>
                            </form>
