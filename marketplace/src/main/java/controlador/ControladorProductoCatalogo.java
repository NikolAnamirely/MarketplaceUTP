 ...
 * @author Lenovo
 */
@WebServlet(name = "ControladorProductoCatalogo", urlPatterns = {"/ControladorProductoCatalogo"})
public class ControladorProductoCatalogo extends HttpServlet {
    ...
    {
            //DECLARO
            String prmTienda,prmpedido,prmuser;
