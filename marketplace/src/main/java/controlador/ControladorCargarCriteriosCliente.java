 ...
 * @author Lenovo
 */
@WebServlet(name = "ControladorCargarCriteriosCliente", urlPatterns = {"/ControladorCargarCriteriosCliente"})
public class ControladorCargarCriteriosCliente extends HttpServlet {
