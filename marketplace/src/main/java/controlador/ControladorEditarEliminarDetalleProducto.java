 ...
 * @author Lenovo
 */
@WebServlet(name = "ControladorEditarEliminarDetalleProducto", urlPatterns = {"/ControladorEditarEliminarDetalleProducto"})
public class ControladorEditarEliminarDetalleProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorEditarEliminarDetalleProducto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorEditarEliminarDetalleProducto at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException 
    {
            ...
            //PARAMETRO PRODUCTO
            String  prmcodpedido;
            prmcodpedido = request.getParameter("idped");
