 ...
 * @author Lenovo
 */
@WebServlet(name = "ControladorRegistrarPedidoNuevo", urlPatterns = {"/ControladorRegistrarPedidoNuevo"})
public class ControladorRegistrarPedidoNuevo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorRegistrarPedidoNuevo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorRegistrarPedidoNuevo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException 
    {
           ...
           System.out.println(id+subtotal+igv+total+hora+estado+tipopago+repartidor+id_usuario);
