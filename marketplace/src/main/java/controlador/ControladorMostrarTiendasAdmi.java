 ...
 * @author Lenovo
 */
@WebServlet(name = "ControladorMostrarTiendasAdmi", urlPatterns = {"/ControladorMostrarTiendasAdmi"})
public class ControladorMostrarTiendasAdmi extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
            ...
            List<Tienda> lista = daoTien.ConsultarTiendas();
            

            request.setAttribute("listTien", lista);
            ...
            request.getRequestDispatcher("/TiendasAdm.jsp").
