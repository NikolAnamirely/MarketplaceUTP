 ...
 * @author Lenovo
 */
@WebServlet(name = "ControladorEditarVendedor", urlPatterns = {"/ControladorEditarVendedor"})
public class ControladorEditarVendedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorEditarVendedor</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorEditarVendedor at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException 
    {
           ...
           ven.setDistrito(Integer.parseInt(id_distrito));
            ...
            //ENVIO AL DAO
           daoVendedor.editar(ven);

           request.getRequestDispatcher("ControladorMostrarVendedoresAdmi").
