 ...
 * @author Lenovo
 */
@WebServlet(name = "ControladorRegistrarPedidoPorCod", urlPatterns = {"/ControladorRegistrarPedidoPorCod"})
public class ControladorRegistrarPedidoPorCod extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorRegistrarPedidoPorCod</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorRegistrarPedidoPorCod at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException 
    {
            ...
            request.getRequestDispatcher("totalpedido.jsp").
