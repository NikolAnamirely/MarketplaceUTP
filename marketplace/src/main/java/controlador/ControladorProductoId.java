 ...
 * @author Lenovo
 */
@WebServlet(name = "ControladorProductoId", urlPatterns = {"/ControladorProductoId"})
public class ControladorProductoId extends HttpServlet {
