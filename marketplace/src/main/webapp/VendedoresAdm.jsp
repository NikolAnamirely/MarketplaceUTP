            ...
            <div class="container">
                ...
                <table style="width: 100%; border: 1px solid #ced4da;">
                        <tr class= "tablaspern" style="width: 100%;background: #495057;">
                            ...
                            <td style="width: 10%;">Primer Apellido</td>
                            <td style="width: 10%;">Segundo Apellido</td>
                         ...
                         <%
                            List<Vendedor> lista = (List<Vendedor>)request.getAttribute("listVen");   
                            if(lista != null)
                            {
                                for(Vendedor aux :lista)
                                {
                                    String es;
                                    if(aux.getActivo()==(1)){
                                        es="Activo";
                        ...
                        %>
                                    <tr class="grilla_campo"> 
                                        <td style="text-align: center"><%= aux.getId()%></td>
                                           ...
                                           <td style="text-align: center"><%= aux.getPrimerapellido()%></td>
                                           <td style="text-align: center"><%= aux.getSegundoapellido()%></td>
                                           <td style="text-align: center"><%= aux.getEmail()%></td>
                                           <td style="text-align: center"><%= aux.getTelefono()%></td>
                                           <td style="text-align: center"><%= aux.getActivo()%></td>
                                           <td style="text-align: center"><%= aux.getDireccion()%></td>
                                           <td align="center"><a href="ControladorVendedorId?idven=<%=aux.getId()%>"><img src="imagenes/editar.png"></a></td>
