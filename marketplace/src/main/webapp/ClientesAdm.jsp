            ...
            <div class="container">
                ...
                <table style="width: 100%; border: 1px solid #ced4da;">
                        <tr class= "tablaspern" style="width: 100%;background: #495057;">
                         ...
                         <%
                            List<Cliente> lista = (List<Cliente>)request.getAttribute("listCli");   
                            if(lista != null)
                            {
                        ...
                        %>
                                    <tr class="grilla_campo"> 
                                        <td style="text-align: center"><%= aux.getId()%></td>
                                           ...
                                           <td align="center"><a href="ControladorClienteId?idcli=<%=aux.getId()%>"><img src="imagenes/editar.png"></a></td>
