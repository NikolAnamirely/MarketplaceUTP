<%-- 
    Document   : editarprod
    Created on : 30 set. 2021, 13:39:16
    Author     : Lenovo
--%>
            ...
            <div class="container">
                        <form id="contactForm">
                            <div class="row">	       
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Unidades" id="unidades" class="form-control" name="unidades" required data-error="Porfavor ingresa las unidades">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
